...
if __name__ == '__main__':
    ...
    parser.add_argument('-gongkuang', type=str, default="供液不足", help='本分类器的工况类别')
    parser.add_argument('-new_img_path', type=str, default="./make_label_test_sig(shang_chu25_xia_chu120)_16_diacc", help='new images path')
    parser.add_argument('-model_path', type=str, default="E:\\aboutjiqixuexi\\gybz_16\\checkpoint_wei_sig(shang_chu25_xia_chu120)\epoch_25_train_dataset_genai_area_zuizhong-best-acc_0.9928118393234673.pth", help='model path')
