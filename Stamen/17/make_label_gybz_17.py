...
if __name__ == '__main__':
    ...
    parser.add_argument('-new_img_path', type=str, default="./make_label_test_sig(shang_chu33_xia_chu50)_16_e38", help='new images path')
    parser.add_argument('-model_path', type=str, default="E:\\aboutjiqixuexi\\gybz_17\\checkpoint_wei_sig(shang_chu33_xia_chu50)\\epoch_38_train_dataset_genai_area_zuizhong-best-acc_0.9943820224719101.pth", help='model path')
