...
if __name__ == '__main__':
    ...
    parser.add_argument('-img_path', type=str, default="./train_dataset_genai_area_zuizhong\\15", help='images path')
    parser.add_argument('-gongkuang', type=str, default="游动漏失", help='本分类器的工况类别')
    parser.add_argument('-new_img_path', type=str, default="./make_label_test_sig(shang_chu33_xia_chu50)_15_e51", help='new images path')
    parser.add_argument('-model_path', type=str, default="E:\\aboutjiqixuexi\\ydfls_18\\checkpoint_wei_sig(shang_chu33_xia_chu50)\\epoch_51_train_dataset_genai_area_zuizhong-best-acc_0.9992592592592593.pth", help='model path')
