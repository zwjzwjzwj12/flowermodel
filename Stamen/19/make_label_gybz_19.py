...
if __name__ == '__main__':
    ...
    parser.add_argument('-img_path', type=str, default="./test_dataset_genai_area_zuizhong\\19", help='images path')
    parser.add_argument('-gongkuang', type=str, default="固定阀漏失", help='本分类器的工况类别')
    parser.add_argument('-new_img_path', type=str, default="./make_label_test_sig(shang_chu33_xia_chu50)_19_e39", help='new images path')
    parser.add_argument('-model_path', type=str, default="E:\\aboutjiqixuexi\\gdfls_19\\checkpoint_wei_sig(shang_chu10_xia_chu50)\\epoch_57_train_dataset_genai_area_zuizhong-best-acc_0.998062015503876.pth", help='model path')
