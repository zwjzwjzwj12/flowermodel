...
if __name__ == '__main__':
    ...
    parser.add_argument('-img_path', type=str, default="./test_dataset_genai_area_zuizhong\\15", help='images path')
    parser.add_argument('-gongkuang', type=str, default="双阀漏失", help='本分类器的工况类别')
    parser.add_argument('-new_img_path', type=str, default="./make_label_test_sig(shang_chu5_xia_chu50)_15_e68", help='new images path')
    parser.add_argument('-model_path', type=str, default="E:\\aboutjiqixuexi\\sfls_20\\checkpoint_wei_sig(shang_chu5_xia_chu50)\\epoch_68_train_dataset_genai_area_zuizhong-best-acc_0.9956521739130435.pth", help='model path')
