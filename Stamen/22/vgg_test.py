...
if __name__ == '__main__':
    ...
    parser.add_argument('-img_path', type=str, default="train_dataset_genai_area_zuizhong",
                        help='images path')
    parser.add_argument('-gongkuang', type=str, default="气体影响", help='本分类器的工况类别')
    parser.add_argument('-new_img_path', type=str, default="./judge_false_add.area_gybz_17_sig(shang_chu33_xia_chu100)",
                        help='new images path')
    parser.add_argument('-model_path', type=str,
                        default="E:\\aboutjiqixuexi\\gybz_17\\checkpoint_wei_sig(shang_chu33_xia_chu100)\\epoch_69_train_dataset_genai_area_zuizhong-best-acc_0.9874301675977654.pth",
                        help='model path')
