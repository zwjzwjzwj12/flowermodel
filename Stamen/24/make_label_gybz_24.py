...
if __name__ == '__main__':
    ...
    parser.add_argument('-img_path', type=str, default="./train_dataset_genai_area_zuizhong\\22", help='images path')
    parser.add_argument('-gongkuang', type=str, default="下碰泵", help='本分类器的工况类别')
    parser.add_argument('-new_img_path', type=str, default="./make_label_test_sig(shang_chu33_xia_chu50)_22_e55", help='new images path')
    parser.add_argument('-model_path', type=str, default="E:\\aboutjiqixuexi\\xpb_22\\checkpoint_wei_sig(shang_chu33_xia_chu50)\\epoch_55_train_dataset_genai_area_zuizhong-best-acc_0.9983552631578947.pth", help='model path')
