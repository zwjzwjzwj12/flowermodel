...
if __name__ == '__main__':
    ...
    parser.add_argument('-img_path', type=str, default="test_dataset_genai_area_zuizhong",
                        help='images path')
    parser.add_argument('-gongkuang', type=str, default="泵塞脱出工作筒", help='本分类器的工况类别')
    parser.add_argument('-new_img_path', type=str, default="./judge_false_add.area_gybz_24_sig(shang_chu33_xia_chu100)_1",
                        help='new images path')
    parser.add_argument('-model_path', type=str,
                        default="E:\\aboutjiqixuexi\\zstcgzt_24\\checkpoint_wei_sig(shang_chu33_xia_chu50)\\epoch_15_train_dataset_genai_area_zuizhong-best-acc_1.0.pth",
                        help='model path')
