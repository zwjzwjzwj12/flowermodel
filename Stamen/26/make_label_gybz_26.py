...
if __name__ == '__main__':
    ...
    parser.add_argument('-gongkuang', type=str, default="油井出砂", help='本分类器的工况类别')
    parser.add_argument('-new_img_path', type=str, default="./make_label_test_sig(shang_chu20_xia_chu20)_26_e16", help='new images path')
    parser.add_argument('-model_path', type=str, default="E:\\aboutjiqixuexi\\yjcs_26\\checkpoint_wei_sig(shang_chu20_xia_chu20)_2\\epoch_16_train_dataset_genai_area_zuizhong-best-acc_1.0.pth", help='model path')
