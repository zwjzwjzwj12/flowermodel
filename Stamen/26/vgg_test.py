...
if __name__ == '__main__':
    ...
    parser.add_argument('-new_img_path', type=str, default="./judge_false_add.area_gybz_26_sig(shang_chu33_xia_chu100)_e41",
                        help='new images path')
    parser.add_argument('-model_path', type=str,
                        default="E:\\aboutjiqixuexi\\yjcs_26\\checkpoint_wei_sig(shang_chu20_xia_chu20)_2\\epoch_16_train_dataset_genai_area_zuizhong-best-acc_1.0.pth",
                        help='model path')
