...
if __name__ == '__main__':
    ...
    parser.add_argument('-houzhui', type=str, default="wei_sig(shang_chu20_xia_chu20)_2", help='本次保存路径、曲线路径的后缀')
    ...
    parser.add_argument('-milestones', type=float, default=[0.25, 0.5, 0.7], help='milestones')
